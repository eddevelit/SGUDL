 ...
 <div class="wrapper">
  <header class="main-header">
    ...
    <!-- mini logo for sidebar mini 50x50 pixels -->
      ...
      <img src="../Content/img/logo.png" alt="" style="height:65px">
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="./media/images/usuario-160x160.png" class="img-circle" alt="User Image">
                <p>      
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class=" box box-solid bg-teal-gradient ">
            <div class="box-header">
              <i class="fa fa-th"></i>
              <h3 class="box-title">Detalle Asistencias y Calificaciones por Alumno</h3>
  ...
  <footer class="main-footer">
    ...
    <strong class="text-center">Copyright &copy; 2016 <a href="#">Sistemas de Gestión UDL</a>.</strong> ITGAM-SoportDesing
  </footer>
