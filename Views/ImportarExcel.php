      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="./ImportarExcel.php">
            ...
            <li class="treeview">
          <a href="./ImportarExcelReticula.php">
            <i class="fa fa-files-o"></i>
            <span>Incorporar Reticulas a BD</span>
            <span class="pull-right-container">
              <span class="label label-primary pull-right"></span>
            </span>
          </a>
...
?>
  <div class="box"> 
    ...
              <th class="text-center">Alumno</th>
              ...
              <th class="text-center">Escuela procedencia</th>
          ...
          <?php
              ...
              if(isset($_POST['radio'])){
                ...
                foreach ($objHoja as $iIndice=>$objCelda) {
                    ...
                    $NOMCAR     = $objCelda['A'];
                    $GRUPO      = $objCelda['B'];
                    $MATRICULA  = $objCelda['C'];
                    $ALUMNO     = $objCelda['D'];
                    $DELEGACION = $objCelda['E'];
                    $EDAD       = $objCelda['F'];
                    $ESCPROC    = $objCelda['G'];
                    $CICLO      = $objCelda['H'];
                    $TIPO       = $objCelda['I'];
                    ...
                    if($NOMCAR != 'NOMCARR' && $GRUPO != 'GRUPO' && $MATRICULA != 'MATRICULA' &&	 $ALUMNO != 'ALUMNO' && $DELEGACION != 'DELEGACION' && $EDAD != 'EDAD'
                      && $ESCPROC != 'ESCUELA DE PROCEDENCIA' && $CICLO != 'Ciclo' && $TIPO != 'Tipo' && $MATERIA != 'Materia' && $CALFINAL  != 'CalFinal')
                    {
                  ...
                  {
                    if($_POST['radio']=='s'){
                        $sql="INSERT INTO ALUMNOSGENERAL
                              (NOMCAR , GRUPO , MATRICULA , ALUMNO , DELEGACION , EDAD , ESCPROC , CICLO , TIPO , MATERIA , CALFINAL )
                              VALUES ('$NOMCAR','$GRUPO','$MATRICULA','$ALUMNO','$DELEGACION','$EDAD','$ESCPROC','$CICLO','$TIPO','$MATERIA','$CALFINAL')";
                              mysql_query($sql);                    
                    }
                  }
