          ...
          $(document).ready(function() {
            ...
            var listarA = function(){
                var table = $("#alumnos").DataTable({
                        "ajax":{
                            "method":"POST",
                            "url":"../../web.config/consulta-Merca.php"
                        },
                        "columns":[
                            {"data":"MATRICULA"},
                            {"data":"ALUMNO"},
...
<div class="wrapper">
  ...
  <div class="content-wrapper bg-aqua">
            ...
            <div class="box-footer no-border">
              <div class="row">
                ...
                <div class="col-xs-4 text-center">
                  <div id="#"></div>
                  <div class="knob-label">
                   <table class="table table-hover"><h3>Materias no cursadas</h3>
                    <thead>
                          <th>Materia</th>
                          <th>Cuatrimestre</th>
                    </thead>
                             ...
                             // header('cotent-type:application/json; charset=utf-8');
                                ...
                                if(isset($_POST["btn1"])){
                                  ...
                                  if($btn=="Buscar"){
                                    ...
                                    select nombre_materia, semestre_materia from sgudl.materias where id_materia like 'M%' ORDER BY semestre_materia;";
